	...
	<div class="homeBanner" style="background-image: url(images/banner.jpg);">
		<div class="container text-center text-white">
			<div class="row justify-content-center">
				<div class="col-md-10">
					<h1 class="text-white">GET UP DRESS UP SHOW UP AND NEVER GIVE UP !</h1>
					<p>The Best Way to Predict Your Future Is To Create It...So Lets Make Room For Good Stuff Like a BOSS</p>
				</div>
	...
	<div class="section2">
		<div class="container">
			<div class="text-center smallTitle">
				<h2>READ COMMENT CREATE POST</h2>
				<p>Acknowledge Ideas Of Others Get Acknowledged With Yours</p>
			</div>
